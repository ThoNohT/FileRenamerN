...
{
    internal class LowerCaser : RenamerBase
    {
        public override string Name
        {
            get { return "LowerCaser"; }
        }

        public override string Description
        {
            get { return "Changes all characters of the filename to lower case."; }
        }

        public override string Process(string path, string fileName, string extension, Dictionary<string, object> parameterValues)
        {
            return string.Format("{0}{1}{2}", path, fileName.ToLower(), extension);
        }
    }
}
