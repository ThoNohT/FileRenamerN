...
{
    internal class UpperCaser : RenamerBase
    {
        public override string Name
        {
            get { return "UpperCaser";  }
        }

        public override string Description
        {
            get { return "Changes all characters of the filename to uppercase."; }
        }

        public override string Process(string path, string fileName, string extension, Dictionary<string, object> parameterValues)
        {
            return string.Format("{0}{1}{2}", path, fileName.ToUpper(), extension);
        }
    }
}
